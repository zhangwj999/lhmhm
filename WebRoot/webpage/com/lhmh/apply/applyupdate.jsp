			...
			<table cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value" nowrap>
						...
						<input name="doctorName" class="inputxt" value="${applyPage.doctorName}" id="doctorName" readonly="readonly" datatype="*" /> 
				...
				<tr>
					...
					<td class="value">
						...
						<input name="managerName" class="inputxt"  id="managerName" value="${applyPage.managerName}" readonly="readonly" datatype="s1-32" />
				...
				<tr>
					...
					<td class="value" colspan="3">
						<textarea class="inputxt" id="hisSummary"name="hisSummary" ignore="ignore" style="width:70%;height:70px;">${applyPage.hisSummary}</textarea>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value" colspan="3">
						<textarea class="inputxt" id="curDetail" name="curDetail" ignore="ignore" style="width:70%;height:70px;">${applyPage.curDetail}</textarea>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value" colspan="3">
						<textarea class="inputxt" id="meetPurpose" name="meetPurpose" ignore="ignore" style="width:70%;height:70px;">${applyPage.meetPurpose}</textarea>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
			</table>
