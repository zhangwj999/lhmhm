...
function WebOffice1_NotifyCtrlReady() {
	...
	document.all.WebOffice1.LoadOriginalFile("./applyController.do?getDoc&fileId=1", 'doc');
	ProtectFull()
}
// ---------------------== 关闭页面时调用此函数，关闭文件 ==---------------------- //
...
<!-- 		 	<span class="STYLE1">|</span> <input name="button" type="button" onClick="return docOpen()" value="打开本地文件" /></td> -->
	...
	<tr>
		<td colspan="2" rowspan="12" valign="top"><!-- -----------------------------== 装载weboffice控件 ==--------------------------------- --> <SCRIPT>
					var s = ""
						s += "<object id=WebOffice1 height=768 width='100%' style='LEFT: 0px; TOP: 0px' classid='clsid:E77E049B-23FC-4DB8-B756-60529A35FAD5' codebase='${webRoot}/plug-in/webOffice/weboffice_v6.0.5.0.cab#Version=6,0,5,0'>"
